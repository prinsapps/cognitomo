...
const CaseStudy = () => {
  return (
    <Layout>
      ...
      <Hero
        caseStudy
        title="It’s not a museum."
        companyName="it’s a place of ideas."
       // companyColor={COMPANY_COLOR}
        companyWebsite="http://tamilmuseumlondon.org.uk/"
        heroImgConfig={{
      ...
      <Section smallPadding>
        <Section.H2>Tamil Museum London</Section.H2>
        <p>
      ...
      <Section lightBackground>
        <Section.Image
          src={createOptimizedCloudinary(
            'https://res.cloudinary.com/prinsapps/image/upload/v1591929518/cognitomo/Horizontal-version-Full-Colour-2_pji6hb.png',
          )}
